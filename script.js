...
function updateCountdown() {
  ...
  if (diff <= 0) {
    document.getElementById('slideshow-container').innerHTML =
      ...
      '<p>Ich wünschte ich könnte dir gerade einen Kuss geben aber naja das geht ja leider nicht aber ich wünsche dir alles Glück der Welt für dieses Jahr und ich verspreche dir das ich mein Bestes geben werde dir es so schön wie möglich zu machen das ist mein Ziel und dabei bleibt es auch ich denke 2025 wird für uns beide richtig schön Ich liebe dich sehrrrrr</p>';
    return;
  }
